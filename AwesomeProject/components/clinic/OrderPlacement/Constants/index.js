...
export const featured = {
  ...
  categories: [
      ...
      dishes: [
        {
          ...
          name: "Hepatitis B",
          description:
            "Use for Hepatitis B and very affective against these germs of hepatitis",
          price: 10,
          image: require("../../../../assets/Images/HepatitisB.png"),
        },
        {
          ...
          name: "Hepatitis A",
          description:
            "Use for Hepatitis A and very affective against the germs of Hepatitis A",
          price: 10,
        ...
        },
        {
          ...
          name: "Polio",
          description:
            "Use Orally to protect a child from the polio disability",
          price: 10,
          image: require("../../../../assets/Images/HepatitisB.png"),
        },
      ],
      ...
      dishes: [
        {
          ...
          name: "Flu Vaccine",
          description:
            "Affective for the Seasonal Flu and protect the body against the Flu",
          price: 10,
        ...
        },
        {
          ...
          name: "Hib Vaccine",
          description:
            "Affective against the Hib virus and provide full immunization against this virus",
          price: 10,
        ...
        },
        {
          ...
          name: "MMR Vaccine",
          description:
            "Affective against the MMR virus and provide full immunization against this virus",
          price: 10,
    ...
    },
    {
      ...
      description:
        "All vaccines recommended for Youngs are given in this category",
      lng: -85.5324269,
      lat: 38.2145602,
      address: "434 second street",
      stars: 4,
